...
// Placeholder brands - replace with actual ones when available
const brands = [
  ...
  { id: 4, name: "Brand 4", logo: "/images/brands/brand4.png" },
  { id: 5, name: "Brand 5", logo: "/images/brands/brand5.png" },
  { id: 6, name: "Brand 6", logo: "/images/brands/brand6.png" },
];

export default function BrandsBanner() {
  const scrollRef = useRef<HTMLDivElement>(null);

  // Duplicating brands for infinite scroll effect
  ...
  return (
    <div className="py-6">
      ...
      <div className="relative overflow-hidden w-full">
        <div className="absolute left-0 top-0 w-8 h-full bg-gradient-to-r from-gray-50 to-transparent z-10"></div>
        <div className="absolute right-0 top-0 w-8 h-full bg-gradient-to-l from-gray-50 to-transparent z-10"></div>
        
        <div 
          ref={scrollRef} 
          className="flex items-center space-x-12 brand-scroll"
        >
          {allBrands.map((brand, index) => (
            <div key={`${brand.id}-${index}`} className="flex-shrink-0 mx-6">
              <div className="w-24 h-16 md:w-32 md:h-20 relative grayscale hover:grayscale-0 transition-all duration-300">
                <svg
